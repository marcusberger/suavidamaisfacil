        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel-2">Inscreva-se e receba conteúdos exlcusivos</h4>
                </div>

                <div class="modal-body">
                    <p>Preencha os campos abaixo e faça o download do nosso e-book grátis com dicas surpreendentes</p>
                    <div class="card-painel-post" >
                        <form id="formCadastroModal" method="POST" action="insert-modal.php">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" type="text" id="nome-modal" name="nome"-modal required>
                                <label class="mdl-textfield__label" for="nome-modal">Nome completo</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" type="email" id="email-modal" name="email-modal" required>
                                <label class="mdl-textfield__label" for="email-modal">e-mail</label>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button data-dismiss="modal" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button-footer">
                                    Cancelar
                                </button>
                            </div>
                            ...
                            <input type="hidden" id="nome-db-modal" name="nome-db-modal">
                            <input type="hidden" id="email-db-modal" name="email-db-modal">
                        </form>
                    </div>
                </div>
            </div>
        ...
        <header class="mdl-layout__header header-color">
            <div class="mdl-layout__header-row header-color">
                ...
                <nav class="mdl-navigation mdl-layout--large-screen-only">
                    <a class="mdl-navigation__link" href="auto.html">Auto</a>
                    <a class="mdl-navigation__link" href="pet.html">Pet</a>
                    <a class="mdl-navigation__link" href="gadget.html">Gadget</a>
                    <a class="mdl-navigation__link" href="sua-vida.html">Sua vida</a>
                </nav>
            </div>
